...
$table = "(SELECT purchase_info.*, tallas.talla_name, purchase_item.item_quantity, SUM(purchase_item.item_total) as purchase_price, SUM(purchase_item.item_quantity) as total_stock, SUM(purchase_price.paid_amount) as paid_amount FROM purchase_info 
      LEFT JOIN tallas ON (purchase_info.talla_id = tallas.talla_id)
      ...
      WHERE $where_query
      GROUP BY purchase_info.talla_id
