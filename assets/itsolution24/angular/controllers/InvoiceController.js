...
function (
    ...
    $("#invoice-invoice-list").dataTable({
        ...
        "dom": "lfBrtip",
        "serverSide": true,
        "ajax": API_URL + "/_inc/invoice.php?from="+$from+"&to="+$to+"&type="+$type+"&customer_id="+$customerId+"&currier="+$currier,
        "fixedHeader": true,
        "order": [[ 1, "desc"]],
        "aLengthMenu": [
            [10, 25, 50, 100, 200, -1],
        ...
        "columnDefs": [
            {"targets": [1, 5, 6, 7, 8, 9], "orderable": false},
    ...
    $(document).delegate("#customer_id", "select2:select", function (e) {
        ...
        var cid=$('#customer_id').val(),currier=$('#currier').val();
        window.location = window.baseUrl+"/admin/invoice.php?customer_id="+cid+"&currier="+currier;
    });
